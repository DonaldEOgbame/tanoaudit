...
Security score: {sec}/100 · Optimization score: {opt}/100 · Completeness score: {comp}/100
...
def _templated(
    ...
    return (
        ...
        f"{scan.files} files. Security score {scan.security_score}/100, optimization "
...
async def generate_executive_summary(
    ...
    prompt = _PROMPT.format(
        ...
        sec=scan.security_score, opt=scan.optimization_score,
